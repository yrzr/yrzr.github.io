...
After using my mirror (https://ftp.yrzr.tk/opnsense), we could install packages and do a hw-probe and see the [result](https://bsd-hardware.info/?probe=ebca9e6d70).
